...
| Platform | File | Note |
|---|---|---|
| Android | `reaktor-leitstand-debug.apk` | Debug-signed, installs directly (allow unknown sources) |
| Windows | `Reaktor-Leitstand-Windows.exe` | Portable version, no installation needed. Unsigned — a SmartScreen warning on first launch is expected ("More info" → "Run anyway") |
